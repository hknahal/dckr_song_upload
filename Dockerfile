...
#RUN wget https://raw.githubusercontent.com/hknahal/dckr_song_upload/master/tools/download.py -O /scripts/download
RUN wget https://raw.githubusercontent.com/hknahal/dckr_song_upload/master/tools/create_manifest.py -O /scripts/create_manifest

#RUN chmod +x /scripts/upload
RUN chmod +x /scripts/create_manifest
